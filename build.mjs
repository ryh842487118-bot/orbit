...
const [shell,...styles]=await Promise.all(['src/shell.html','src/style.css','src/ui/earthsense.css','src/ui/trajectory.css','src/ui/compact.css'].map(file=>readFile(path.join(root,file),'utf8')));
